...
class DatabaseHelper
  ...
  Future<double> calculateAverageFuelConsumption(int carId, String startDate, String endDate) async {
    final db = await database;
    ...
    return totalFuelConsumed / totalDistanceTraveled * 100; // Consumption in liters per 100 km
  }
